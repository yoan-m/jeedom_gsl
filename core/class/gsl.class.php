...
class gsl extends eqLogic {
    ...
    public static function getMapLayers(){
        return array('OpenStreetMap.Mapnik'=>array('maxZoom'=>19,'url'=>'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png','attribution'=>'&copy; <a href=\"https://www.openstreetmap.org/copyright\">OpenStreetMap</a> contributors'),
    ...
    public function toHtml($_version = 'dashboard') {
        ...
        if(array_key_exists(config::byKey('light-theme', 'gsl', ''), self::getMapLayers())){
            ...
            $data['light-theme'] = array_values(self::getMapLayers())[0];
        }
        if(array_key_exists(config::byKey('dark-theme', 'gsl', ''), self::getMapLayers())){
            ...
            $data['dark-theme'] = array_values(self::getMapLayers())[0];
        }
